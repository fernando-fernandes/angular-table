...
export class ApiService {
  ...
  getProductsData() {
    return [
      {
        id: '1000',
        nomeAluno: 'Brenda Ferreira Gomes',
        serieEscolar: 'Faltam 4 anos ou mais para 1º ano EF',
        nomeResponsavel: 'Luís Sousa Gomes',
        celularResponsavel: '(11) 91234-1000',
        emailResponsavel: 'email@email.com',
        dadosAtualizados: '1',
        dataAtualizacao: '20/01/2024',
        atualizadoPor: 'Felipe Correia Sousa',
        statusIt: 'Confirmado',
      },
      {
        id: '2000',
        nomeAluno: 'Rafael Cunha Souza',
        serieEscolar: '3º ano - Ensino Fundamental',
        nomeResponsavel: 'Camila Cardoso Cavalcanti',
        celularResponsavel: '(11) 91234-1000',
        emailResponsavel: 'email@email.com',
        dadosAtualizados: '2',
        dataAtualizacao: '-',
